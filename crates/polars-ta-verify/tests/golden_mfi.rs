...
#[test]
fn mfi_period14_normal_1000() {
    run_mfi_golden("mfi_period14_normal_1000.json", 14, 1e-10);
}
#[test]
fn mfi_period14_boundary_exact() {
    run_mfi_golden("mfi_period14_boundary_exact.json", 14, 1e-10);
}
#[test]
...
#[test]
fn mfi_period14_with_nan() {
    run_mfi_golden("mfi_period14_with_nan_5pct.json", 14, 1e-10);
}
#[test]
fn mfi_period14_all_same_value() {
    run_mfi_golden("mfi_period14_all_same_value.json", 14, 1e-10);
}
#[test]
fn mfi_period14_real_btcusdt() {
    run_mfi_golden("mfi_period14_real_btcusdt_1d.json", 14, 1e-7);
}
#[test]
fn mfi_period14_real_flat_period() {
    run_mfi_golden("mfi_period14_real_flat_period.json", 14, 1e-10);
}
