...
#[test]
fn correl_period30_normal_1000() {
    run_correl_golden("correl_period30_normal_1000.json", 30, 1e-8);
}

#[test]
fn correl_period30_boundary_exact() {
    run_correl_golden("correl_period30_boundary_exact.json", 30, 1e-8);
}
...
#[test]
fn correl_period30_with_nan() {
    run_correl_golden("correl_period30_with_nan_5pct.json", 30, 1e-8);
}

#[test]
fn correl_period30_all_same_value() {
    run_correl_golden("correl_period30_all_same_value.json", 30, 1e-6);
}

#[test]
fn correl_period30_real_btcusdt() {
    run_correl_golden("correl_period30_real_btcusdt_1d.json", 30, 1e-8);
}
