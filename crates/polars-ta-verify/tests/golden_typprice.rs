...
#[test]
fn typprice_normal_1000() {
    run_typprice_golden("typprice__normal_1000.json", 1e-10);
}
#[test]
#[ignore = "NaN propagation: ta-lib skips NaN in multi-input windows, we propagate per IEEE 754"]
fn typprice_with_nan() {
    run_typprice_golden("typprice__with_nan_5pct.json", 1e-10);
}
#[test]
fn typprice_all_same_value() {
    run_typprice_golden("typprice__all_same_value.json", 1e-10);
}
#[test]
fn typprice_real_btcusdt() {
    run_typprice_golden("typprice__real_btcusdt_1d.json", 1e-10);
}
#[test]
fn typprice_real_flat_period() {
    run_typprice_golden("typprice__real_flat_period.json", 1e-10);
}
