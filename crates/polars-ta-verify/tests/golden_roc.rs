...
#[test]
fn roc_period10_normal_1000() {
    run_roc_golden("roc_period10_normal_1000.json", 10, 1e-10);
}
#[test]
fn roc_period10_boundary_exact() {
    run_roc_golden("roc_period10_boundary_exact.json", 10, 1e-10);
}
#[test]
...
fn roc_period10_with_nan() {
    run_roc_golden("roc_period10_with_nan_5pct.json", 10, 1e-10);
}
#[test]
fn roc_period10_all_same_value() {
    run_roc_golden("roc_period10_all_same_value.json", 10, 1e-10);
}
#[test]
fn roc_period10_real_btcusdt() {
    run_roc_golden("roc_period10_real_btcusdt_1d.json", 10, 1e-8);
}
#[test]
fn roc_period10_real_flat_period() {
    run_roc_golden("roc_period10_real_flat_period.json", 10, 1e-8);
}
