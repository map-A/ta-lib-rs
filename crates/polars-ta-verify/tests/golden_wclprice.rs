...
#[test]
fn wclprice_normal_1000() {
    run_wclprice_golden("wclprice__normal_1000.json", 1e-10);
}
#[test]
#[ignore = "NaN propagation: ta-lib skips NaN in multi-input windows, we propagate per IEEE 754"]
fn wclprice_with_nan() {
    run_wclprice_golden("wclprice__with_nan_5pct.json", 1e-10);
}
#[test]
fn wclprice_all_same_value() {
    run_wclprice_golden("wclprice__all_same_value.json", 1e-10);
}
#[test]
fn wclprice_real_btcusdt() {
    run_wclprice_golden("wclprice__real_btcusdt_1d.json", 1e-10);
}
#[test]
fn wclprice_real_flat_period() {
    run_wclprice_golden("wclprice__real_flat_period.json", 1e-10);
}
