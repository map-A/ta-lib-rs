...
#[test]
fn apo_fast12_slow26_normal_1000() { run_apo_golden("apo_fast12_slow26_normal_1000.json", 12, 26, 1e-10); }
#[test]
fn apo_fast12_slow26_boundary_exact() { run_apo_golden("apo_fast12_slow26_boundary_exact.json", 12, 26, 1e-10); }
#[test]
...
fn apo_fast12_slow26_with_nan() { run_apo_golden("apo_fast12_slow26_with_nan_5pct.json", 12, 26, 1e-10); }
#[test]
fn apo_fast12_slow26_all_same_value() { run_apo_golden("apo_fast12_slow26_all_same_value.json", 12, 26, 1e-10); }
#[test]
fn apo_fast12_slow26_real_btcusdt() { run_apo_golden("apo_fast12_slow26_real_btcusdt_1d.json", 12, 26, 1e-6); }
#[test]
fn apo_fast12_slow26_real_flat_period() { run_apo_golden("apo_fast12_slow26_real_flat_period.json", 12, 26, 1e-6); }
