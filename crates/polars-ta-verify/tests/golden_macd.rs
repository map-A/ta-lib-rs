...
#[test]
fn macd_normal_1000() { run_macd_golden("macd_fast12_slow26_signal9_normal_1000.json", 12, 26, 9, 1e-10); }
#[test]
fn macd_boundary_exact() { run_macd_golden("macd_fast12_slow26_signal9_boundary_exact.json", 12, 26, 9, 1e-10); }
#[test]
...
#[test]
fn macd_with_nan() { run_macd_golden("macd_fast12_slow26_signal9_with_nan_5pct.json", 12, 26, 9, 1e-10); }
#[test]
fn macd_all_same_value() { run_macd_golden("macd_fast12_slow26_signal9_all_same_value.json", 12, 26, 9, 1e-10); }
#[test]
fn macd_real_btcusdt() { run_macd_golden("macd_fast12_slow26_signal9_real_btcusdt_1d.json", 12, 26, 9, 1e-7); }
#[test]
fn macd_real_flat_period() { run_macd_golden("macd_fast12_slow26_signal9_real_flat_period.json", 12, 26, 9, 1e-10); }
