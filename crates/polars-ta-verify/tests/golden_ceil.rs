...
#[test]
fn ceil_normal_1000() { run_ceil_golden("ceil__normal_1000.json", 1e-10); }
#[test]
#[ignore = "NaN propagation: ta-lib skips NaN, we propagate per IEEE 754"]
fn ceil_with_nan() { run_ceil_golden("ceil__with_nan_5pct.json", 1e-10); }
#[test]
fn ceil_all_same_value() { run_ceil_golden("ceil__all_same_value.json", 1e-10); }
#[test]
fn ceil_real_btcusdt() { run_ceil_golden("ceil__real_btcusdt_1d.json", 1e-10); }
#[test]
fn ceil_real_flat_period() { run_ceil_golden("ceil__real_flat_period.json", 1e-10); }
