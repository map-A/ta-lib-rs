...
fn run_midprice_golden(filename: &str, period: usize, epsilon: f64) {
    ...
    let high = golden.get_input("high")
        .unwrap_or_else(|e| panic!("Failed to parse high input: {}", e));
    let low = golden.get_input("low")
...
#[test]
fn midprice_period14_normal_1000() { run_midprice_golden("midprice_period14_normal_1000.json", 14, 1e-10); }
#[test]
fn midprice_period14_boundary_exact() { run_midprice_golden("midprice_period14_boundary_exact.json", 14, 1e-10); }
#[test]
...
fn midprice_period14_with_nan() { run_midprice_golden("midprice_period14_with_nan_5pct.json", 14, 1e-10); }
#[test]
fn midprice_period14_all_same_value() { run_midprice_golden("midprice_period14_all_same_value.json", 14, 1e-10); }
#[test]
fn midprice_period14_real_btcusdt() { run_midprice_golden("midprice_period14_real_btcusdt_1d.json", 14, 1e-10); }
#[test]
fn midprice_period14_real_flat_period() { run_midprice_golden("midprice_period14_real_flat_period.json", 14, 1e-10); }
