...
#[test]
fn acos_normal_1000() { run_acos_golden("acos__normal_1000.json", 1e-10); }
#[test]
#[ignore = "NaN propagation: ta-lib skips NaN, we propagate per IEEE 754"]
fn acos_with_nan() { run_acos_golden("acos__with_nan_5pct.json", 1e-10); }
#[test]
fn acos_all_same_value() { run_acos_golden("acos__all_same_value.json", 1e-10); }
#[test]
fn acos_real_btcusdt() { run_acos_golden("acos__real_btcusdt_1d.json", 1e-10); }
#[test]
fn acos_real_flat_period() { run_acos_golden("acos__real_flat_period.json", 1e-10); }
