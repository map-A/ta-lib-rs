...
#[test]
fn midpoint_period14_normal_1000() { run_midpoint_golden("midpoint_period14_normal_1000.json", 14, 1e-10); }
#[test]
fn midpoint_period14_boundary_exact() { run_midpoint_golden("midpoint_period14_boundary_exact.json", 14, 1e-10); }
#[test]
...
#[test]
fn midpoint_period14_with_nan() { run_midpoint_golden("midpoint_period14_with_nan_5pct.json", 14, 1e-10); }
#[test]
fn midpoint_period14_all_same_value() { run_midpoint_golden("midpoint_period14_all_same_value.json", 14, 1e-10); }
#[test]
fn midpoint_period14_real_btcusdt() { run_midpoint_golden("midpoint_period14_real_btcusdt_1d.json", 14, 1e-10); }
#[test]
fn midpoint_period14_real_flat_period() { run_midpoint_golden("midpoint_period14_real_flat_period.json", 14, 1e-10); }
