...
#[test]
fn atan_normal_1000() { run_atan_golden("atan__normal_1000.json", 1e-10); }
#[test]
#[ignore = "NaN propagation: ta-lib skips NaN, we propagate per IEEE 754"]
fn atan_with_nan() { run_atan_golden("atan__with_nan_5pct.json", 1e-10); }
#[test]
fn atan_all_same_value() { run_atan_golden("atan__all_same_value.json", 1e-10); }
#[test]
fn atan_real_btcusdt() { run_atan_golden("atan__real_btcusdt_1d.json", 1e-10); }
#[test]
fn atan_real_flat_period() { run_atan_golden("atan__real_flat_period.json", 1e-10); }
