...
#[test]
fn sin_normal_1000() {
    run_sin_golden("sin__normal_1000.json", 1e-10);
}
#[test]
#[ignore = "NaN propagation: ta-lib skips NaN, we propagate per IEEE 754"]
fn sin_with_nan() {
    run_sin_golden("sin__with_nan_5pct.json", 1e-10);
}
#[test]
fn sin_all_same_value() {
    run_sin_golden("sin__all_same_value.json", 1e-10);
}
#[test]
fn sin_real_btcusdt() {
    run_sin_golden("sin__real_btcusdt_1d.json", 1e-10);
}
#[test]
fn sin_real_flat_period() {
    run_sin_golden("sin__real_flat_period.json", 1e-10);
}
