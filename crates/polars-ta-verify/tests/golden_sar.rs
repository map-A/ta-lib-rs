...
#[test]
fn sar_normal_1000() { run_sar_golden("sar_acceleration0.02_maximum0.2_normal_1000.json", 0.02, 0.2, 1e-10); }
#[test]
fn sar_boundary_exact() { run_sar_golden("sar_acceleration0.02_maximum0.2_boundary_exact.json", 0.02, 0.2, 1e-10); }
#[test]
...
fn sar_with_nan() { run_sar_golden("sar_acceleration0.02_maximum0.2_with_nan_5pct.json", 0.02, 0.2, 1e-10); }
#[test]
fn sar_all_same_value() { run_sar_golden("sar_acceleration0.02_maximum0.2_all_same_value.json", 0.02, 0.2, 1e-10); }
#[test]
fn sar_real_btcusdt() { run_sar_golden("sar_acceleration0.02_maximum0.2_real_btcusdt_1d.json", 0.02, 0.2, 1e-7); }
#[test]
fn sar_real_flat_period() { run_sar_golden("sar_acceleration0.02_maximum0.2_real_flat_period.json", 0.02, 0.2, 1e-10); }
