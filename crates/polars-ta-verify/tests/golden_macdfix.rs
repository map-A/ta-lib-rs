...
#[test]
fn macdfix_normal_1000() {
    run_macdfix_golden("macdfix_signal9_normal_1000.json", 9, 1e-10);
}
#[test]
fn macdfix_boundary_exact() {
    run_macdfix_golden("macdfix_signal9_boundary_exact.json", 9, 1e-10);
}
#[test]
...
#[test]
fn macdfix_with_nan() {
    run_macdfix_golden("macdfix_signal9_with_nan_5pct.json", 9, 1e-10);
}
#[test]
fn macdfix_all_same_value() {
    run_macdfix_golden("macdfix_signal9_all_same_value.json", 9, 1e-10);
}
#[test]
fn macdfix_real_btcusdt() {
    run_macdfix_golden("macdfix_signal9_real_btcusdt_1d.json", 9, 1e-7);
}
#[test]
fn macdfix_real_flat_period() {
    run_macdfix_golden("macdfix_signal9_real_flat_period.json", 9, 1e-10);
}
