...
#[test]
fn cosh_normal_1000() { run_cosh_golden("cosh__normal_1000.json"); }
#[test]
#[ignore = "NaN propagation: ta-lib skips NaN, we propagate per IEEE 754"]
fn cosh_with_nan() { run_cosh_golden("cosh__with_nan_5pct.json"); }
#[test]
fn cosh_all_same_value() { run_cosh_golden("cosh__all_same_value.json"); }
#[test]
fn cosh_real_btcusdt() { run_cosh_golden("cosh__real_btcusdt_1d.json"); }
#[test]
fn cosh_real_flat_period() { run_cosh_golden("cosh__real_flat_period.json"); }
