...
#[test]
fn adosc_normal_1000() { run_adosc_golden("adosc_fast3_slow10_normal_1000.json", 3, 10, 1e-5); }
#[test]
fn adosc_boundary_exact() { run_adosc_golden("adosc_fast3_slow10_boundary_exact.json", 3, 10, 1e-8); }
#[test]
...
fn adosc_with_nan() { run_adosc_golden("adosc_fast3_slow10_with_nan_5pct.json", 3, 10, 1e-10); }
#[test]
fn adosc_all_same_value() { run_adosc_golden("adosc_fast3_slow10_all_same_value.json", 3, 10, 1e-10); }
#[test]
fn adosc_real_btcusdt() { run_adosc_golden("adosc_fast3_slow10_real_btcusdt_1d.json", 3, 10, 1e-3); }
#[test]
fn adosc_real_flat_period() { run_adosc_golden("adosc_fast3_slow10_real_flat_period.json", 3, 10, 1e-7); }
