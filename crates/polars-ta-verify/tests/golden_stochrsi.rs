...
#[test]
fn stochrsi_normal_1000() { run_stochrsi_golden("stochrsi_period14_fastk5_fastd3_normal_1000.json", 14, 5, 3, 1e-10); }
#[test]
fn stochrsi_boundary_exact() { run_stochrsi_golden("stochrsi_period14_fastk5_fastd3_boundary_exact.json", 14, 5, 3, 1e-10); }
#[test]
...
fn stochrsi_with_nan() { run_stochrsi_golden("stochrsi_period14_fastk5_fastd3_with_nan_5pct.json", 14, 5, 3, 1e-10); }
#[test]
fn stochrsi_all_same_value() { run_stochrsi_golden("stochrsi_period14_fastk5_fastd3_all_same_value.json", 14, 5, 3, 1e-10); }
#[test]
fn stochrsi_real_btcusdt() {
    // StochRSI uses Wilder-smoothed RSI → relaxed epsilon
    run_stochrsi_golden("stochrsi_period14_fastk5_fastd3_real_btcusdt_1d.json", 14, 5, 3, 1e-7);
}
#[test]
#[ignore = "ta-lib NaN propagation differs: ta-lib skips NaN in rolling windows; our impl propagates NaN via IEEE 754"]
fn stochrsi_real_flat_period() { run_stochrsi_golden("stochrsi_period14_fastk5_fastd3_real_flat_period.json", 14, 5, 3, 1e-10); }
