...
#[test]
fn sinh_normal_1000() {
    run_sinh_golden("sinh__normal_1000.json");
}
#[test]
#[ignore = "NaN propagation: ta-lib skips NaN, we propagate per IEEE 754"]
fn sinh_with_nan() {
    run_sinh_golden("sinh__with_nan_5pct.json");
}
#[test]
fn sinh_all_same_value() {
    run_sinh_golden("sinh__all_same_value.json");
}
#[test]
fn sinh_real_btcusdt() {
    run_sinh_golden("sinh__real_btcusdt_1d.json");
}
#[test]
fn sinh_real_flat_period() {
    run_sinh_golden("sinh__real_flat_period.json");
}
