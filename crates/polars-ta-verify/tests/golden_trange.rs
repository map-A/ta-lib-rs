...
#[test]
fn trange_normal_1000() {
    run_trange_golden("trange__normal_1000.json", 1e-10);
}
#[test]
fn trange_boundary_exact() {
    run_trange_golden("trange__boundary_exact.json", 1e-10);
}
#[test]
...
fn trange_with_nan() {
    run_trange_golden("trange__with_nan_5pct.json", 1e-10);
}
#[test]
fn trange_all_same_value() {
    run_trange_golden("trange__all_same_value.json", 1e-10);
}
#[test]
fn trange_real_btcusdt() {
    run_trange_golden("trange__real_btcusdt_1d.json", 1e-7);
}
#[test]
fn trange_real_flat_period() {
    run_trange_golden("trange__real_flat_period.json", 1e-10);
}
