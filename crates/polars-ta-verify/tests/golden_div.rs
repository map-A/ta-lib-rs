...
#[test]
fn div_normal_1000() {
    run_div_golden("div__normal_1000.json", 1e-10);
}
#[test]
fn div_all_same_value() {
    run_div_golden("div__all_same_value.json", 1e-10);
}
#[test]
fn div_real_btcusdt() {
    run_div_golden("div__real_btcusdt_1d.json", 1e-10);
}
#[test]
fn div_real_flat_period() {
    run_div_golden("div__real_flat_period.json", 1e-10);
}
#[test]
#[ignore = "NaN propagation differs"]
fn div_with_nan() {
    run_div_golden("div__with_nan_5pct.json", 1e-10);
}
