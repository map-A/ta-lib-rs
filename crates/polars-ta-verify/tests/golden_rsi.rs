...
#[test]
fn rsi_period14_normal_1000() { run_rsi_golden("rsi_period14_normal_1000.json", 14, 1e-10); }
#[test]
fn rsi_period14_boundary_exact() { run_rsi_golden("rsi_period14_boundary_exact.json", 14, 1e-10); }
#[test]
...
fn rsi_period14_with_nan() { run_rsi_golden("rsi_period14_with_nan_5pct.json", 14, 1e-10); }
#[test]
fn rsi_period14_all_same_value() { run_rsi_golden("rsi_period14_all_same_value.json", 14, 1e-10); }
#[test]
...
#[test]
fn rsi_period14_real_flat_period() { run_rsi_golden("rsi_period14_real_flat_period.json", 14, 1e-7); }
