...
#[test]
fn mult_normal_1000() { run_mult_golden("mult__normal_1000.json", 1e-10); }
#[test]
fn mult_all_same_value() { run_mult_golden("mult__all_same_value.json", 1e-10); }
#[test]
fn mult_real_btcusdt() { run_mult_golden("mult__real_btcusdt_1d.json", 1e-4); }
#[test]
fn mult_real_flat_period() { run_mult_golden("mult__real_flat_period.json", 1e-10); }
#[test]
#[ignore = "NaN propagation differs"]
fn mult_with_nan() { run_mult_golden("mult__with_nan_5pct.json", 1e-10); }
