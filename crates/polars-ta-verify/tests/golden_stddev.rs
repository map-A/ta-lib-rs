...
#[test]
fn stddev_period5_normal_1000() {
    run_stddev_golden("stddev_period5_nbdev1.0_normal_1000.json", 5, 1.0, 1e-8);
}

#[test]
fn stddev_period5_boundary_exact() {
    run_stddev_golden("stddev_period5_nbdev1.0_boundary_exact.json", 5, 1.0, 1e-8);
}
...
fn stddev_period5_with_nan() {
    run_stddev_golden("stddev_period5_nbdev1.0_with_nan_5pct.json", 5, 1.0, 1e-8);
}

#[test]
fn stddev_period5_all_same_value() {
    run_stddev_golden("stddev_period5_nbdev1.0_all_same_value.json", 5, 1.0, 1e-6);
}
...
fn stddev_period5_real_flat_period() {
    ...
    run_stddev_golden(
        "stddev_period5_nbdev1.0_real_flat_period.json",
        5,
        1.0,
        1e-5,
    );
