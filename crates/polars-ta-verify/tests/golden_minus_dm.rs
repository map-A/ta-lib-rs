...
#[test]
fn minus_dm_period14_normal_1000() { run_minus_dm_golden("minus_dm_period14_normal_1000.json", 14, 1e-10); }
#[test]
fn minus_dm_period14_boundary_exact() { run_minus_dm_golden("minus_dm_period14_boundary_exact.json", 14, 1e-10); }
#[test]
...
fn minus_dm_period14_with_nan() { run_minus_dm_golden("minus_dm_period14_with_nan_5pct.json", 14, 1e-10); }
#[test]
fn minus_dm_period14_all_same_value() { run_minus_dm_golden("minus_dm_period14_all_same_value.json", 14, 1e-10); }
#[test]
fn minus_dm_period14_real_btcusdt() { run_minus_dm_golden("minus_dm_period14_real_btcusdt_1d.json", 14, 1e-7); }
#[test]
fn minus_dm_period14_real_flat_period() { run_minus_dm_golden("minus_dm_period14_real_flat_period.json", 14, 1e-7); }
