...
#[test]
fn exp_normal_1000() { run_exp_golden("exp__normal_1000.json"); }
#[test]
#[ignore = "NaN propagation: ta-lib skips NaN, we propagate per IEEE 754"]
fn exp_with_nan() { run_exp_golden("exp__with_nan_5pct.json"); }
#[test]
fn exp_all_same_value() { run_exp_golden("exp__all_same_value.json"); }
#[test]
fn exp_real_btcusdt() { run_exp_golden("exp__real_btcusdt_1d.json"); }
#[test]
fn exp_real_flat_period() { run_exp_golden("exp__real_flat_period.json"); }
