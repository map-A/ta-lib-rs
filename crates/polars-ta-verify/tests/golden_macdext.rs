...
#[test]
fn macdext_normal_1000() {
    run_macdext_golden(
        "macdext_fast12_slow26_signal9_matype1_normal_1000.json",
        12,
        26,
        9,
        1,
...
#[test]
fn macdext_boundary_exact() {
    run_macdext_golden(
        "macdext_fast12_slow26_signal9_matype1_boundary_exact.json",
        12,
        26,
        9,
        1,
...
fn macdext_with_nan() {
    run_macdext_golden(
        "macdext_fast12_slow26_signal9_matype1_with_nan_5pct.json",
        12,
        26,
        9,
        1,
...
#[test]
fn macdext_all_same_value() {
    run_macdext_golden(
        "macdext_fast12_slow26_signal9_matype1_all_same_value.json",
        12,
        26,
        9,
        1,
...
#[test]
fn macdext_real_btcusdt() {
    run_macdext_golden(
        "macdext_fast12_slow26_signal9_matype1_real_btcusdt_1d.json",
        12,
        26,
        9,
        1,
...
#[test]
fn macdext_real_flat_period() {
    run_macdext_golden(
        "macdext_fast12_slow26_signal9_matype1_real_flat_period.json",
        12,
        26,
        9,
        1,
