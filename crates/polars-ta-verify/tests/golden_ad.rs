...
#[test]
fn ad_normal_1000() { run_ad_golden("ad__normal_1000.json", 1e-5); }
#[test]
#[ignore = "ta-lib NaN propagation differs: our AD propagates NaN via IEEE 754, ta-lib skips"]
fn ad_with_nan() { run_ad_golden("ad__with_nan_5pct.json", 1e-5); }
#[test]
fn ad_all_same_value() { run_ad_golden("ad__all_same_value.json", 1e-5); }
#[test]
fn ad_real_btcusdt() { run_ad_golden("ad__real_btcusdt_1d.json", 1e-3); }
#[test]
fn ad_real_flat_period() { run_ad_golden("ad__real_flat_period.json", 1e-5); }
