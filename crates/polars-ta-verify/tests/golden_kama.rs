...
#[test]
fn kama_period10_normal_1000() { run_kama_golden("kama_period10_normal_1000.json", 10, 1e-8); }
#[test]
fn kama_period10_boundary_exact() { run_kama_golden("kama_period10_boundary_exact.json", 10, 1e-8); }
#[test]
...
#[test]
fn kama_period10_with_nan() { run_kama_golden("kama_period10_with_nan_5pct.json", 10, 1e-8); }
#[test]
fn kama_period10_all_same_value() { run_kama_golden("kama_period10_all_same_value.json", 10, 1e-8); }
#[test]
fn kama_period10_real_btcusdt() { run_kama_golden("kama_period10_real_btcusdt_1d.json", 10, 1e-8); }
#[test]
fn kama_period10_real_flat_period() { run_kama_golden("kama_period10_real_flat_period.json", 10, 1e-8); }
