...
#[test]
fn beta_period5_normal_1000() { run_beta_golden("beta_period5_normal_1000.json", 5, 1e-8); }

#[test]
fn beta_period5_boundary_exact() { run_beta_golden("beta_period5_boundary_exact.json", 5, 1e-8); }
...
fn beta_period5_with_nan() { run_beta_golden("beta_period5_with_nan_5pct.json", 5, 1e-8); }

#[test]
fn beta_period5_all_same_value() { run_beta_golden("beta_period5_all_same_value.json", 5, 1e-6); }

#[test]
fn beta_period5_real_btcusdt() { run_beta_golden("beta_period5_real_btcusdt_1d.json", 5, 1e-8); }

#[test]
fn beta_period5_real_flat_period() { run_beta_golden("beta_period5_real_flat_period.json", 5, 1e-8); }
