...
#[test]
fn tsf_period14_normal_1000() { run_tsf_golden("tsf_period14_normal_1000.json", 14, 1e-8); }

#[test]
fn tsf_period14_boundary_exact() { run_tsf_golden("tsf_period14_boundary_exact.json", 14, 1e-8); }
...
fn tsf_period14_with_nan() { run_tsf_golden("tsf_period14_with_nan_5pct.json", 14, 1e-8); }

#[test]
fn tsf_period14_all_same_value() { run_tsf_golden("tsf_period14_all_same_value.json", 14, 1e-8); }
...
#[test]
fn tsf_period14_real_flat_period() { run_tsf_golden("tsf_period14_real_flat_period.json", 14, 1e-8); }
