...
#[test]
fn ln_normal_1000() { run_ln_golden("ln__normal_1000.json", 1e-10); }
#[test]
#[ignore = "NaN propagation: ta-lib skips NaN, we propagate per IEEE 754"]
fn ln_with_nan() { run_ln_golden("ln__with_nan_5pct.json", 1e-10); }
#[test]
fn ln_all_same_value() { run_ln_golden("ln__all_same_value.json", 1e-10); }
#[test]
fn ln_real_btcusdt() { run_ln_golden("ln__real_btcusdt_1d.json", 1e-10); }
#[test]
fn ln_real_flat_period() { run_ln_golden("ln__real_flat_period.json", 1e-10); }
