...
#[test]
fn rocr_period10_normal_1000() {
    run_rocr_golden("rocr_period10_normal_1000.json", 10, 1e-10);
}
#[test]
fn rocr_period10_boundary_exact() {
    run_rocr_golden("rocr_period10_boundary_exact.json", 10, 1e-10);
}
#[test]
...
fn rocr_period10_with_nan() {
    run_rocr_golden("rocr_period10_with_nan_5pct.json", 10, 1e-10);
}
#[test]
fn rocr_period10_all_same_value() {
    run_rocr_golden("rocr_period10_all_same_value.json", 10, 1e-10);
}
#[test]
fn rocr_period10_real_btcusdt() {
    run_rocr_golden("rocr_period10_real_btcusdt_1d.json", 10, 1e-8);
}
#[test]
fn rocr_period10_real_flat_period() {
    run_rocr_golden("rocr_period10_real_flat_period.json", 10, 1e-8);
}
