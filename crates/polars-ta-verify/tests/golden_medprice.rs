...
#[test]
fn medprice_normal_1000() { run_medprice_golden("medprice__normal_1000.json", 1e-10); }
#[test]
#[ignore = "NaN propagation: ta-lib skips NaN in multi-input windows, we propagate per IEEE 754"]
fn medprice_with_nan() { run_medprice_golden("medprice__with_nan_5pct.json", 1e-10); }
#[test]
fn medprice_all_same_value() { run_medprice_golden("medprice__all_same_value.json", 1e-10); }
#[test]
fn medprice_real_btcusdt() { run_medprice_golden("medprice__real_btcusdt_1d.json", 1e-10); }
#[test]
fn medprice_real_flat_period() { run_medprice_golden("medprice__real_flat_period.json", 1e-10); }
