...
#[test]
fn dema_period20_normal_1000() { run_dema_golden("dema_period20_normal_1000.json", 20, 1e-10); }
#[test]
fn dema_period20_boundary_exact() { run_dema_golden("dema_period20_boundary_exact.json", 20, 1e-10); }
#[test]
...
#[test]
fn dema_period20_with_nan() { run_dema_golden("dema_period20_with_nan_5pct.json", 20, 1e-10); }
#[test]
fn dema_period20_all_same_value() { run_dema_golden("dema_period20_all_same_value.json", 20, 1e-10); }
#[test]
fn dema_period20_real_btcusdt() { run_dema_golden("dema_period20_real_btcusdt_1d.json", 20, 1e-7); }
#[test]
fn dema_period20_real_flat_period() { run_dema_golden("dema_period20_real_flat_period.json", 20, 1e-10); }
