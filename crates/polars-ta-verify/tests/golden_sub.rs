...
#[test]
fn sub_normal_1000() {
    run_sub_golden("sub__normal_1000.json", 1e-10);
}
#[test]
fn sub_all_same_value() {
    run_sub_golden("sub__all_same_value.json", 1e-10);
}
#[test]
fn sub_real_btcusdt() {
    run_sub_golden("sub__real_btcusdt_1d.json", 1e-10);
}
#[test]
fn sub_real_flat_period() {
    run_sub_golden("sub__real_flat_period.json", 1e-10);
}
#[test]
#[ignore = "NaN propagation differs"]
fn sub_with_nan() {
    run_sub_golden("sub__with_nan_5pct.json", 1e-10);
}
