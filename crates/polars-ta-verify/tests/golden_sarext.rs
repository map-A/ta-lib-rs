...
#[test]
fn sarext_normal_1000() {
    run_sarext_golden("sarext__normal_1000.json", 1e-10);
}
#[test]
fn sarext_boundary_exact() {
    run_sarext_golden("sarext__boundary_exact.json", 1e-10);
}
#[test]
...
fn sarext_with_nan() {
    run_sarext_golden("sarext__with_nan_5pct.json", 1e-10);
}
#[test]
fn sarext_all_same_value() {
    run_sarext_golden("sarext__all_same_value.json", 1e-10);
}
#[test]
fn sarext_real_btcusdt() {
    run_sarext_golden("sarext__real_btcusdt_1d.json", 1e-7);
}
#[test]
fn sarext_real_flat_period() {
    run_sarext_golden("sarext__real_flat_period.json", 1e-10);
}
