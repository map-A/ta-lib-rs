...
#[test]
fn stochf_normal_1000() {
    run_stochf_golden("stochf_fastk5_fastd3_normal_1000.json", 5, 3, 1e-10);
}
#[test]
fn stochf_boundary_exact() {
    run_stochf_golden("stochf_fastk5_fastd3_boundary_exact.json", 5, 3, 1e-10);
}
#[test]
...
fn stochf_with_nan() {
    run_stochf_golden("stochf_fastk5_fastd3_with_nan_5pct.json", 5, 3, 1e-10);
}
#[test]
fn stochf_all_same_value() {
    run_stochf_golden("stochf_fastk5_fastd3_all_same_value.json", 5, 3, 1e-10);
}
#[test]
fn stochf_real_btcusdt() {
    run_stochf_golden("stochf_fastk5_fastd3_real_btcusdt_1d.json", 5, 3, 1e-7);
}
#[test]
fn stochf_real_flat_period() {
    run_stochf_golden("stochf_fastk5_fastd3_real_flat_period.json", 5, 3, 1e-10);
}
