...
#[test]
fn log10_normal_1000() {
    run_log10_golden("log10__normal_1000.json", 1e-10);
}
#[test]
#[ignore = "NaN propagation: ta-lib skips NaN, we propagate per IEEE 754"]
fn log10_with_nan() {
    run_log10_golden("log10__with_nan_5pct.json", 1e-10);
}
#[test]
fn log10_all_same_value() {
    run_log10_golden("log10__all_same_value.json", 1e-10);
}
#[test]
fn log10_real_btcusdt() {
    run_log10_golden("log10__real_btcusdt_1d.json", 1e-10);
}
#[test]
fn log10_real_flat_period() {
    run_log10_golden("log10__real_flat_period.json", 1e-10);
}
