...
#[test]
fn ultosc_normal_1000() {
    run_ultosc_golden(
        "ultosc_period17_period214_period328_normal_1000.json",
        7,
        14,
        28,
        1e-10,
...
#[test]
fn ultosc_boundary_exact() {
    run_ultosc_golden(
        "ultosc_period17_period214_period328_boundary_exact.json",
        7,
        14,
        28,
        1e-10,
...
fn ultosc_with_nan() {
    run_ultosc_golden(
        "ultosc_period17_period214_period328_with_nan_5pct.json",
        7,
        14,
        28,
        1e-10,
...
#[test]
fn ultosc_all_same_value() {
    run_ultosc_golden(
        "ultosc_period17_period214_period328_all_same_value.json",
        7,
        14,
        28,
        1e-10,
...
#[test]
fn ultosc_real_btcusdt() {
    run_ultosc_golden(
        "ultosc_period17_period214_period328_real_btcusdt_1d.json",
        7,
        14,
        28,
        1e-7,
...
#[test]
fn ultosc_real_flat_period() {
    run_ultosc_golden(
        "ultosc_period17_period214_period328_real_flat_period.json",
        7,
        14,
        28,
        1e-10,
