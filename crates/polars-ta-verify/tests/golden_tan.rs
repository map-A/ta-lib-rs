...
fn run_tan_golden(filename: &str) {
    ...
    assert_close_relative(&actual, golden.get_output_values("values").unwrap(), 1e-8, 1e-10, &label);
}

#[test]
fn tan_normal_1000() { run_tan_golden("tan__normal_1000.json"); }
#[test]
#[ignore = "NaN propagation: ta-lib skips NaN, we propagate per IEEE 754"]
fn tan_with_nan() { run_tan_golden("tan__with_nan_5pct.json"); }
#[test]
fn tan_all_same_value() { run_tan_golden("tan__all_same_value.json"); }
#[test]
fn tan_real_btcusdt() { run_tan_golden("tan__real_btcusdt_1d.json"); }
#[test]
fn tan_real_flat_period() { run_tan_golden("tan__real_flat_period.json"); }
