...
#[test]
fn sqrt_normal_1000() {
    run_sqrt_golden("sqrt__normal_1000.json", 1e-10);
}
#[test]
#[ignore = "NaN propagation: ta-lib skips NaN, we propagate per IEEE 754"]
fn sqrt_with_nan() {
    run_sqrt_golden("sqrt__with_nan_5pct.json", 1e-10);
}
#[test]
fn sqrt_all_same_value() {
    run_sqrt_golden("sqrt__all_same_value.json", 1e-10);
}
#[test]
fn sqrt_real_btcusdt() {
    run_sqrt_golden("sqrt__real_btcusdt_1d.json", 1e-10);
}
#[test]
fn sqrt_real_flat_period() {
    run_sqrt_golden("sqrt__real_flat_period.json", 1e-10);
}
